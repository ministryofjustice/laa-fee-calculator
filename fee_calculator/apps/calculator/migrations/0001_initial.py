    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bist_bill_sub_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fees', to='calculator.BillSubType')),
            ],
        ),
        migrations.CreateModel(
            name='Scheme',
        ...
        migrations.AddField(
            model_name='fee',
            name='scheme',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fees', to='calculator.Scheme'),
        ),
        migrations.AddField(
            model_name='billsubtype',
            name='bill_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sub_types', to='calculator.BillType'),
        ),
    ]
