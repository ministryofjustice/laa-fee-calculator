...
base_path = 'fee_calculator/apps/calculator/management/commands/lgfs_2025_data'
...
class Command(BaseCommand):
    help = 'Uplift fees in the 2025 LGFS Fee Scheme - Option A: Freeze non-base scenarios'

    def handle(self, *args, **options):
        scheme = Scheme.objects.get(pk=13)  # Update to your new scheme ID
        ...
        for price in prices:
            ...
            # All other scenarios (Retrial, Transfers, etc.) - skip (leave unchanged)
